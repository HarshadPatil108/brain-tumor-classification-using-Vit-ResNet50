...
Technology UsedPyTorch: For model training and inference.
Hugging Face transformers: For the pre-trained ViT model.
Gradio: For building and serving the interactive web demo.
